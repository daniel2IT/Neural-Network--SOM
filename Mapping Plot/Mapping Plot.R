...
#grafikas, parodantis objektu atvaizdavima sesiakampeje (hexagonal) tinklo strukturoje:

plot(kohmap, type="mapping",labels = as.integer(rusis), col = as.integer(rusis), main = "mapping plot")